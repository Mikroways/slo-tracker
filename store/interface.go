...
type SLO interface {
	...
	CreateWorkingHour(req *schema.StoreWorkingHour) (*schema.StoreWorkingHour, *errors.AppError)
	GetWorkingSchedule(SLOID uint) (*[]schema.StoreWorkingHour, *errors.AppError)
	DeleteWorkingHours(SLOID uint) *errors.AppError
}
